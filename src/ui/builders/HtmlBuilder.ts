    ...
    if (config.type === "file") {
      ...
      if (config.fileList) {
        const imagePreviewAttr = config.imagePreview
          ...
          : "";
        const label = "Choose " + (config.imagePreview ? "images" : "files");
        return `
      ...
      <div class="file-list-items" data-input-id="${config.id}"${imagePreviewAttr}></div>`;
      }
...
<html lang="fr">
  ...
  <body>
    ...
    <section class="actions">
      <button id="generate-all-btn" class="btn">Process All</button>
      <button id="generate-design-system-btn" class="btn">Process Design System</button>
      <button id="generate-datas-components-btn" class="btn">Process Datas & Components</button>
    </section>
